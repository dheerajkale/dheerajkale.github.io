      ...
      >
        ...
        <div className="flex max-h-full w-full max-w-4xl flex-col">
          {document.type === 'image' ? (
            <>
              <div
                className={`flex min-h-0 flex-1 items-center justify-center ${zoomed ? 'cursor-zoom-out overflow-auto' : 'cursor-zoom-in'
                  }`}
              ...
              >
                <img
                  ...
                  className={`transition-all duration-300 ${zoomed
                      ? 'm-auto block h-auto w-full max-w-full'
